...
public class cpuGpuMem12 {
                ...
                if (osType) {
                    ...
                    while ((line = reader.readLine()) != null) {
                        if (line.trim().matches("\\d+")) {
                            falut[0] = Double.parseDouble(line.trim());
                        }
                    }
                    ...
                    if (totalMemory > 0) {
                        falut[1] = (double) (totalMemory - freeMemory) / totalMemory * 100;
                    }
                    ...
                    if (isNvidiaGPUAvailable()) {
                        ...
                        if ((line = reader.readLine()) != null) {
                            falut[2] = Double.parseDouble(line.trim());
                        }
                    }
                    ...
                    while ((line = reader.readLine()) != null) {
                        if (line.contains("%Cpu(s)")) {
                            ...
                            falut[0] = Double.parseDouble(cpuUsageStr);
                        }
                    }
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("CPU使用率: " + result[0] + "%");
            System.out.println("内存使用率: " + result[1] + "%");
            System.out.println("GPU使用率: " + result[2] + "%");
        } catch (IOException | InterruptedException e) {
            e.printStackTrace();
        }
    }
